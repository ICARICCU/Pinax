...
class pinaxcms_contents_views_renderer_CellEditDraftDeleteVisible extends pinaxcms_contents_views_renderer_AbstractCellEdit
{
    function renderCell($key, $value, $row, $columnName)
    {
        ...
        $output = $this->renderEditButton($key, $row, $row->hasPublishedVersion()).
                  ...
                  $this->renderDeleteLanguageButton($key, $row).
