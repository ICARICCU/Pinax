...
class pinaxcms_views_components_ExternalVideo extends pinax_components_Component
{
...
/**
 * Class pinaxcms_views_components_ExternalVideo_render
 */
class pinaxcms_views_components_ExternalVideo_render extends pinax_components_render_Render
{
    /**
     * @return string
     */
