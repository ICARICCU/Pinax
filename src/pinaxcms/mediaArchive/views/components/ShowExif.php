<?php
class pinaxcms_mediaArchive_views_components_ShowExif extends pinax_components_Component
{
    protected $imageId;
    ...
    function render($outputMode = NULL, $skipChilds = false)
    {
        ...
        if ($ar->media_type == 'IMAGE') {
            $ar = pinax_ObjectFactory::createModel('pinaxcms.mediaArchive.models.Exif');
