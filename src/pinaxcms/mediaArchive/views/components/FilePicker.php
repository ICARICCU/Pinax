<?php
class pinaxcms_mediaArchive_views_components_FilePicker extends pinax_components_Component
{
    function init()
    {
	...
	function render($outputMode = NULL, $skipChilds = false)
	{
		...
		$this->_application->_rootComponent->addOutputCode(pinax_helpers_CSS::linkCSSfile(  __Paths::get('APPLICATION_TEMPLATE').'css/customStorageBrowser.css' ), 'head' );
