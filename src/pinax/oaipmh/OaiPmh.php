...
class pinax_oaipmh_OaiPmh
{
	...
	{
		$datestamp = pinax_localeDate2default($datestamp);
		$datestamp = pinax_oaipmh_OaiPmh::date2UTCdatestamp($datestamp);
		if (!pinax_oaipmh_OaiPmh::checkDateFormat($datestamp)) {
