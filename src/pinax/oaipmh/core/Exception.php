<?php
class pinax_oaipmh_core_Exception extends Exception
{
    public $oaiCode;
    ...
    {
        return ' <error code="'.pinax_oaipmh_OaiPmh::encode( $this->oaiCode ).'">'.pinax_oaipmh_OaiPmh::encode( $this->message )."</error>";
    }
