<?php
trait pinax_oaipmh_core_XmlOutputTrait
{
    /**
	 * @param string $string
	...
	/**
	 * @param pinax_oaipmh_models_VO_MetadataVO $metadata
	 * @return string
	 */
	private function openMetadataHeader(pinax_oaipmh_models_VO_MetadataVO $metadata)
	{
	 ...
	 * @return string
	 */
	private function closeMetadataHeader(pinax_oaipmh_models_VO_MetadataVO $metadata)
	{
	...
	{
		$datestamp = $this->date2UTCdatestamp(pinax_localeDate2default($datestamp));
