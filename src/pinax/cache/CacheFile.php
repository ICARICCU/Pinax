...
class pinax_cache_CacheFile extends Cache_Lite
{
	var $_fileExtension = '';
	...
	static function cleanPHP($cacheCode=null)
	{
        ...
        $evt = array('type' => PNX_EVT_CACHE_CLEAN, 'data' => $cacheCode);
        $evtObject = &pinax_ObjectFactory::createObject('pinax.events.Event', null, $evt);
        pinax_events_EventDispatcher::dispatchEvent($evtObject);
    }
