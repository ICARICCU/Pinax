...
class pinax_dataAccessDoctrine_SqlRecordIterator extends PinaxObject implements pinax_dataAccessDoctrine_interfaces_IteratorInterface
{
    ...
    public function load($query, $params=null)
    {
        if (method_exists($this, $query)) {
            $this->querySqlToExec = pinax_helpers_PhpScript::callMethodWithParams($this, $query, $params);
        } else {
     ...
     *
     * @return PinaxObject|mixed|null|StdClass
     */
     ...
     * @param  string $order
     * @return pinax_dataAccessDoctrine_SqlRecordIterator
     */
    ...
    {
        return md5(serialize($this->querySqlToExec).serialize($this->lastParams));
    }
}
