...
class pinax_dataAccessDoctrine_RelationJoinTable extends pinax_dataAccessDoctrine_AbstractRelation
{
    ...
    {
        $this->record = pinax_ObjectFactory::createModel($this->className);
        $this->iterator = null;
