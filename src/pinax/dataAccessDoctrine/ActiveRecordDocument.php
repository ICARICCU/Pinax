...
class pinax_dataAccessDoctrine_ActiveRecordDocument extends pinax_dataAccessDoctrine_AbstractActiveRecord
{
    ...
    protected $splitLanguages = false;
    protected $monolanguage = false;
    protected $visibilityOnLoad = true;
    protected $translateOnLoad = true;
    ...
    protected static $typeMap = array(Type::INTEGER => 'int',
                                      ...
                                      Type::TIME => 'time',
                                      pinax_dataAccessDoctrine_types_Types::ARRAY_ID => 'int');
    ...
    function __construct($connectionNumber=0)
    {
        ...
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_ID, Doctrine\DBAL\Types\Type::INTEGER, 10, true, null, null));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_TYPE, Doctrine\DBAL\Types\Type::STRING, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_FK_SITE_ID, Doctrine\DBAL\Types\Type::INTEGER, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_CREATION_DATE, Doctrine\DBAL\Types\Type::DATETIME, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));

        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_ID, Doctrine\DBAL\Types\Type::INTEGER, 10, true, null, null));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_FK_DOCUMENT, Doctrine\DBAL\Types\Type::INTEGER, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_FK_USER, Doctrine\DBAL\Types\Type::INTEGER, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_TRANSLATED, Doctrine\DBAL\Types\Type::INTEGER, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_MODIFICATION_DATE, Doctrine\DBAL\Types\Type::DATETIME, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_STATUS, Doctrine\DBAL\Types\Type::STRING, 255, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_FK_LANGUAGE, Doctrine\DBAL\Types\Type::INTEGER, 10, false, null, 0, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_IS_VISIBLE, Doctrine\DBAL\Types\Type::INTEGER, 1, false, null, 1, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_OBJECT, Doctrine\DBAL\Types\Type::TEXT, 255, false, null, 1, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));

        if (__Config::get('pinax.dataAccess.document.enableComment')) {
            $this->addField(new pinax_dataAccessDoctrine_SystemField(self::DOCUMENT_DETAIL_NOTE, Doctrine\DBAL\Types\Type::TEXT, 255, false, null, 1, true, false, '', pinax_dataAccessDoctrine_DbField::NOT_INDEXED));
        ...
        if (!self::$indexQueue) {
            self::$indexQueue = new pinax_dataAccessDoctrine_IndexQueue($this->connection);
        }
    }
    ...
    public function getDetailId()
    {
        if (is_null($this->detailPrimaryKeyName)) {
            throw pinax_dataAccessDoctrine_ActiveRecordException::detailPrimaryKeyNotDefined($this->tableName);
        }
    ...
    function getIndexFieldType($fieldName)
    {
        ...
        if (!$field) {
            throw pinax_dataAccessDoctrine_ActiveRecordException::undefinedField($this->_className, $fieldName);
        }
        ...
        if ($field->index & $field::FULLTEXT) {
            ...
            if ($type==pinax_dataAccessDoctrine_types_Types::ARRAY_ID) {
                return self::$typeMap[$this->fields[$fieldName]->option[pinax_dataAccessDoctrine_types_Types::ARRAY_ID]['type']];
            }
    ...
    {
        if ($this->monolanguage!==false) {
            return $this->monolanguage;
        }
    ...
    public function getLanguagesId()
    {
        ...
        $languagesId = pinax_ObjectValues::get('org.pinax', 'languagesId');
        return !is_null($languagesId) ? $languagesId : array($this->getLanguageId());
    }

    public function getUserId()
    {
        return pinax_ObjectValues::get('org.pinax', 'userId');
    }
    ...
    public function load($id, $status='PUBLISHED', $languageId=null)
    {
        ...
        if ($this->type) {
            $qb->andWhere($expr->eq(self::DOCUMENT_TYPE, ':type'))
        ...
        if ($status!==self::STATUS_PUBLISHED_DRAFT) {
            ...
            if ($this->translateOnLoad) {
                $qb->andWhere($expr->eq(self::DOCUMENT_DETAIL_TRANSLATED, ':language_translated'))
                     ->setParameter(':language_translated', 1);
            }

            if ($this->visibilityOnLoad) {
                $qb->andWhere($expr->eq(self::DOCUMENT_DETAIL_IS_VISIBLE, ':visible'))
    ...
    public function loadFromArray($values, $useSet=false)
    {
        ...
        if (!empty($values)) {
            ...
            $documentObjVo = __ObjectFactory::createObject('pinax.dataAccessDoctrine.vo.DocumentObjectVO', $values);
    ...
    public function save($values=null, $forceNew=false, $status=self::STATUS_DRAFT, $comment='')
    {
        ...
        if ($status == self::STATUS_PUBLISHED && __Config::get('pinax.dataAccess.validate')) {
    ...
    protected function insert($values = NULL, $status=self::STATUS_DRAFT, $comment)
    {
        ...
        $document = array(
            ...
            self::DOCUMENT_CREATION_DATE => new pinax_types_DateTime()
        );

        if ($values['document_id']) {
            $document[self::DOCUMENT_ID] = $values['document_id'];
        }
        ...
        if ($r != false) {
            ...
            $languages = $this->splitLanguages ? [$this->getLanguageId()] : $this->getLanguagesId();
    ...
    protected function insertValues($id, $values, $status = self::STATUS_DRAFT, $languageId, $comment)
    {
        ...
        $documentDetail = array(
            ...
            self::DOCUMENT_DETAIL_MODIFICATION_DATE => new pinax_types_DateTime(),
            self::DOCUMENT_DETAIL_STATUS => $status,
            self::DOCUMENT_DETAIL_TRANSLATED => $languageId == $this->getLanguageId(),
            self::DOCUMENT_DETAIL_IS_VISIBLE => isset($this->isVisible[$languageId]) ? $this->isVisible[$languageId] : false
        );
        ...
        $this->loadFromArray($documentDetail);
    ...
    protected function insertValuesIntoIndex($id, $values)
    {
        foreach ($values as $fieldName => $value) {
            ...
            if (!$field->virtual && $field->index != $field::NOT_INDEXED && isset(self::$typeMap[$field->type])) {
                if (!$value && $field->index == $field::FULLTEXT) continue;
    ...
    public function reIndex($reloadContent=true)
    {
        ...
        foreach ($documentDetailIds as $documentDetailId => $data)  {
            ...
            if ($this->fieldExists('fulltext')) {
                $this->fulltext = method_exists($this, 'getFulltext') ? $this->getFulltext($data) : pinaxcms_core_helpers_Fulltext::make($data, $this);
            }
    ...
    protected function updateValues($values, $comment)
    {
        ...
        $r = $this->connection->update($this->getDocumentDetailTableName(), $documentDetail, $identifier, $types);
        $this->loadFromArray(array_merge((array)$this->data, $documentDetail));
        return $r;
    }
    ...
    private function getValueToIndex($type, $value, $fieldOption=null) {
        if ($type == pinax_dataAccessDoctrine_types_Types::ARRAY_ID && $fieldOption && is_object($value)) {
            $field = $fieldOption[pinax_dataAccessDoctrine_types_Types::ARRAY_ID]['field'];
    ...
    {
        if ($this->getStatus() == self::STATUS_PUBLISHED && __Config::get('pinax.dataAccess.validate')) {
            $this->validate($values, $forceNew || $this->isNew());
        }
    ...
    public function delete($id=NULL)
    {
        ...
        list($documentDetailIds, $languages)  = $this->findDetailRecords($id, 'DRAFT');
        $this->deleteDetailsIndex($documentDetailIds, $indexTypes);
    ...
    public function deleteLanguage()
    {
        ...
        $identifier = [self::DOCUMENT_DETAIL_ID => $detailId];

        $documentDetail = array(
            self::DOCUMENT_DETAIL_TRANSLATED => 0,
            self::DOCUMENT_DETAIL_MODIFICATION_DATE => new pinax_types_DateTime(),
        );
    ...
    {
        list($documentDetailIds) = $this->findDetailRecords($this->getId());

        $languages = array_reduce($documentDetailIds, function($carry, $item) {
            if ($item[SELF::DOCUMENT_DETAIL_TRANSLATED]) {
                $carry[] = (int)$item[SELF::DOCUMENT_DETAIL_FK_LANGUAGE];
            }
            return $carry;
        }, []);
        return $languages;
    ...
    public function createRecordIterator() {
        return new pinax_dataAccessDoctrine_RecordIteratorDocument($this);
    }
    ...
    protected function queryBuilderJoinDetail($qb, $tableAlias, $tableDetailAlias, $status, $paramName)
    {
        ...
        $qb->leftJoin($tableAlias, $this->getDocumentDetailTableName(), $tableDetailAlias, $and);
    }
     ...
     * @return void
     */
    public function enableVisibilityOnLoad()
    {
        $this->visibilityOnLoad = true;
    }

    /**
     * @return void
     */
    public function disableVisibilityOnLoad()
    {
     ...
     * @return void
     */
    public function enableTranslateOnLoad()
    {
        $this->translateOnLoad = true;
    }

    /**
     * @return void
     */
    public function disableTranslateOnLoad()
    {
        $this->translateOnLoad = false;
    }
    ...
    {
        if (!__Config::get('ACL_ROLES')) return;
        ...
        $qb->addSelect('acl.*')
            ->leftJoin(self::DOCUMENT_TABLE_ALIAS, $this->getTablePrefix().'joins_tbl', 'acl', $and)
            ->andWhere($or)
