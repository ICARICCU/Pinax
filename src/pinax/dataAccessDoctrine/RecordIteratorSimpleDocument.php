...
class pinax_dataAccessDoctrine_RecordIteratorSimpleDocument extends pinax_dataAccessDoctrine_RecordIterator
{
    ...
    {
        $this->qb = $this->ar->createQueryBuilder(['tableAlias' => self::DOCUMENT_TABLE_ALIAS]);
