...
class pinax_components_PageTitle extends pinax_components_Component
{
	...
	function init()
	{
		...
		$this->addEventListener(PNX_EVT_PAGETITLE_UPDATE, $this);
	}
	...
	function process()
	{
		...
		{
			$this->_content = pinax_encodeOutput($this->getAttribute('value'));
		}
