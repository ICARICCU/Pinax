...
class pinax_components_SimpleList extends pinax_components_ComponentContainer
{
	var $_items;
	...
	function render_html()
	{
		...
		foreach($this->_items as $item)
		{
			...
			{
				$output .= pinax_helpers_Link::makeLink($item['key'], array('title' => $item['value'], 'cssClass' => @$item['cssClass'] ), array(), '', false );
			}
			else
			{
				$output .= $item['value'];
