...
class pinax_components_Accordion extends pinax_components_ComponentContainer
{
	...
	public function init()
	{
		...
		$this->defineAttribute('cssClass', false,  __Config::get('pinax.accordion'), COMPONENT_TYPE_STRING);
		$this->defineAttribute('cssClassHeading', false,  __Config::get('pinax.accordion.heading'), COMPONENT_TYPE_STRING);
		$this->defineAttribute('cssClassTitle', false,  __Config::get('pinax.accordion.title'), COMPONENT_TYPE_STRING);
		$this->defineAttribute('cssClassBodyDiv', false,  __Config::get('pinax.accordion.bodyDiv'), COMPONENT_TYPE_STRING);
		$this->defineAttribute('cssClassBody', false,  __Config::get('pinax.accordion.body'), COMPONENT_TYPE_STRING);
		$this->defineAttribute('cssClassOpen', false,  __Config::get('pinax.accordion.open'), COMPONENT_TYPE_BOOLEAN);
