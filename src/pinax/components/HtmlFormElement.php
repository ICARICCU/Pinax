...
class pinax_components_HtmlFormElement extends pinax_components_ComponentContainer
{
	...
	protected function applyItemTemplate($label, $element) {
		...
		{
			return pinax_helpers_Html::applyItemTemplate($label, $element, $this->_hiddenItem, $this->_rightLabel );
		} else {
	...
	function validate()
	{
        ...
        /** @var pinax_validators_Validator $validator */
		$validator = pinax_ObjectFactory::createObject( 'pinax.validators.Validator' );
