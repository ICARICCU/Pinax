...
jQuery.PinaxRegisterType('checkbox', {
	...
	__construct: function () {
        ...
        $(this).on('change', function(e){
            self._getValue();
            if (group) {
                Pinax.events.broadcast("pinaxcms.checkbox.group", {group: group, checked: $(self).attr('name') });
            }
        });
        ...
        if (group) {
            Pinax.events.on("pinaxcms.checkbox.group", function(e){
