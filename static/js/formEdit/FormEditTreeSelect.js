...
$.PinaxRegisterType('treeselect', {

    __construct: function () {
        var self = this;
        this.element = $(this);
        this.controllerName = this.element.data("controllername");
        this.lazyLoadUrl = Pinax.ajaxUrl + "&controllerName="+this.controllerName + "&method=lazyLoad";
        this.getPathUrl = Pinax.ajaxUrl + "&controllerName="+this.controllerName + "&method=getPath";
