...
Pinax.oop.declare("pinax.FormEdit.modalPage", {
    ...
    initialize: function (element) {
        ...
        element.select2({
            ...
            allowClear: true,
            ajax: {
                url: Pinax.ajaxUrl + '&controllerName='+controller,
                dataType: 'json',
                quietMillis: 250,
                ...
                results: function(data, page ) {
                    data.result.push({id:'__addNewEntry', 'text':'» ' + PinaxLocale.FormEdit.addRecord});
        ...
        Pinax.events.on('pinax.FormEdit.modalPage.message', this.receiveMessage);
    },
    ...
    openModal: function() {
        ...
        $("#modalDiv").on('dialogclose', function(event){
            ...
            if (data != null && data.id === '__addNewEntry') {
